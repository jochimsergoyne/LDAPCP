...
namespace Yvand.LdapClaimsProvider.Configuration
{
    ...
    public class LdapProviderSettings : ILdapProviderSettings
    {
        ...
        public static ClaimTypeConfigCollection ReturnDefaultClaimTypesConfig(string claimsProviderName)
        {
            ...
            newCTConfigCollection.Add(new ClaimTypeConfig { DirectoryObjectType = DirectoryObjectType.User, DirectoryObjectClasses = new List<string>() { "user" }, DirectoryObjectAttribute = "displayName", IsAdditionalLdapSearchAttribute = true, SPEntityDataKey = PeopleEditorEntityDataKeys.DisplayName, DirectoryObjectAdditionalFilter = "(!(objectClass=computer))" });
            newCTConfigCollection.Add(new ClaimTypeConfig { DirectoryObjectType = DirectoryObjectType.User, DirectoryObjectClasses = new List<string>() { "user" }, DirectoryObjectAttribute = "cn", IsAdditionalLdapSearchAttribute = true, DirectoryObjectAdditionalFilter = "(!(objectClass=computer))" });
            newCTConfigCollection.Add(new ClaimTypeConfig { DirectoryObjectType = DirectoryObjectType.User, DirectoryObjectClasses = new List<string>() { "user" }, DirectoryObjectAttribute = "sn", IsAdditionalLdapSearchAttribute = true, DirectoryObjectAdditionalFilter = "(!(objectClass=computer))" });
            newCTConfigCollection.Add(new ClaimTypeConfig { DirectoryObjectType = DirectoryObjectType.User, DirectoryObjectClasses = new List<string>() { "user" }, DirectoryObjectAttribute = "givenName", IsAdditionalLdapSearchAttribute = true, DirectoryObjectAdditionalFilter = "(!(objectClass=computer))" });  // First name
            ...
            newCTConfigCollection.Add(new ClaimTypeConfig { DirectoryObjectType = DirectoryObjectType.User, DirectoryObjectClasses = new List<string>() { "user" }, DirectoryObjectAttribute = "physicalDeliveryOfficeName", IsAdditionalLdapSearchAttribute = false, SPEntityDataKey = PeopleEditorEntityDataKeys.Location, DirectoryObjectAdditionalFilter = "(!(objectClass=computer))" });
            newCTConfigCollection.Add(new ClaimTypeConfig { DirectoryObjectType = DirectoryObjectType.User, DirectoryObjectClasses = new List<string>() { "user" }, DirectoryObjectAttribute = "title", IsAdditionalLdapSearchAttribute = false, SPEntityDataKey = PeopleEditorEntityDataKeys.JobTitle, DirectoryObjectAdditionalFilter = "(!(objectClass=computer))" });
            newCTConfigCollection.Add(new ClaimTypeConfig { DirectoryObjectType = DirectoryObjectType.User, DirectoryObjectClasses = new List<string>() { "user" }, DirectoryObjectAttribute = "msRTCSIP-PrimaryUserAddress", IsAdditionalLdapSearchAttribute = false, SPEntityDataKey = PeopleEditorEntityDataKeys.SIPAddress, DirectoryObjectAdditionalFilter = "(!(objectClass=computer))" });
            newCTConfigCollection.Add(new ClaimTypeConfig { DirectoryObjectType = DirectoryObjectType.User, DirectoryObjectClasses = new List<string>() { "user" }, DirectoryObjectAttribute = "telephoneNumber", IsAdditionalLdapSearchAttribute = false, SPEntityDataKey = PeopleEditorEntityDataKeys.WorkPhone, DirectoryObjectAdditionalFilter = "(!(objectClass=computer))" });

            // Group
            newCTConfigCollection.Add(new ClaimTypeConfig { DirectoryObjectType = DirectoryObjectType.Group, DirectoryObjectClasses = new List<string>() { "group" }, DirectoryObjectAttribute = "sAMAccountName", ClaimType = ClaimsProviderConstants.DefaultMainGroupClaimType, ClaimValueLeadingToken = @"{fqdn}\" });
            newCTConfigCollection.Add(new ClaimTypeConfig { DirectoryObjectType = DirectoryObjectType.Group, DirectoryObjectClasses = new List<string>() { "group" }, DirectoryObjectAttribute = "displayName", IsAdditionalLdapSearchAttribute = true, SPEntityDataKey = PeopleEditorEntityDataKeys.DisplayName });
            newCTConfigCollection.Add(new ClaimTypeConfig { DirectoryObjectType = DirectoryObjectType.Group, DirectoryObjectClasses = new List<string>() { "group" }, DirectoryObjectAttribute = "mail", SPEntityDataKey = PeopleEditorEntityDataKeys.Email });
